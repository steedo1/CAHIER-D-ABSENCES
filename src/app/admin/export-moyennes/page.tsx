            ...
            <div className="grid gap-3 md:grid-cols-3">
              ...
              <div className="flex items-center gap-3 rounded-3xl border border-indigo-100 bg-white px-4 py-3 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-slate-500">
                    Formats disponibles actuellement
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 rounded-3xl border border-amber-100 bg-white px-4 py-3 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-xs font-medium text-slate-500">
                    DESPS, DFA, Rapport F, recensement
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <h2 className="text-xl font-black text-slate-950">
                  Prochains états officiels à intégrer
                </h2>
                <p className="mt-1 text-sm font-medium text-slate-500">
                  Ces blocs sont affichés pour organiser le chantier, mais ils ne
                  déclenchent aucune API non prête.
                </p>
              </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="rounded-[26px] border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-2 text-sm font-medium leading-6 text-slate-600">
                  Rendement général, effectifs classés, non classés, moyennes par
                  niveau et discipline.
                </p>
                <div className="mt-4 inline-flex items-center rounded-full bg-amber-50 px-3 py-1 text-xs font-bold text-amber-700 ring-1 ring-amber-100">
                  Lot API suivant
                </div>
              </div>
