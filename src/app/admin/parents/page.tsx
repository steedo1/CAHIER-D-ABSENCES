...
export default function AdminStudentsByClassPage() {
  ...
  const canCreateOrEditStudents = role !== undefined && !isFinanceManager;
  const canTransferOrRemoveStudents =
    canCreateOrEditStudents || isFinanceManager;
  ...
  async function submitAssign() {
    ...
    try {
      ...
      if (isFinanceManager && assignMode === "new") {
        throw new Error(
          "Le gestionnaire financier peut uniquement transferer un eleve existant.",
        );
      }
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/40 p-4">
          <div className="w-full max-w-lg rounded-2xl border bg-white p-5 shadow-xl">
            ...
            <div className="mt-4">
              ...
              {canCreateOrEditStudents && assignMode === "new" ? (
