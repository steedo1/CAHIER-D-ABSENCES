...
export async function POST(req: Request) {
  ...
  // Mot de passe temporaire = DEFAULT_TEMP_PASSWORD (sinon fallback gÃ©nÃ©rÃ©)
  const password = process.env.DEFAULT_TEMP_PASSWORD || genTempPass(12);

  // 1) CrÃ©e l'utilisateur Auth avec mot de passe (email dÃ©jÃ  confirmÃ©)
