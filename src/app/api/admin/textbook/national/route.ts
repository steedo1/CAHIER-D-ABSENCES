...
export async function GET(req: NextRequest) {
  ...
  // Dans le dashboard école, on affiche seulement la bibliothèque nationale pour copie.
  // L'alimentation globale se fait dans /super/progressions-nationales.
  ...
  if (!canManageNational) query = query.eq("status", "active");
